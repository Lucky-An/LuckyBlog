  ...
  <div>
    ...
    <div class="guide_wrap">
      ...
      >
        ...
        <!-- 战队名称 -->
        <el-table-column :label="$t('attack.rank_table.team')" width="210">
          <template slot-scope="scope">
            <div style="text-align: left">
              ...
              <span
                v-if="
                  scope.row.team_name &&
                    getStrNumber(scope.row.team_name, 15, 9)
                "
                class="marque_box"
              >
        ...
        <!-- 题目 -->
        <el-table-column
          v-for="(t, i) in ranks_list[0].challenges"
          :key="i"
          align="center"
          prop="task"
        ...
        <!-- 变化 -->
        <el-table-column align="center" :label="$t('attack.rank_table.change')">
          <template slot-scope="scope">
            <div
              :class="{
...
<script>
import { rankingData } from '@/api/newAD'
