              ...
              >
                <template slot-scope="scope">
                  <div class="user_name fcenter">
                    <span
                      v-if="
                        scope.row.obj_logo == '' || scope.row.obj_logo == null
                      "
                    ...
                    <span
                      ...
                      class="marque_box"
                    >
                      <span class="marquee">{{ scope.row.obj_name }} &nbsp;&nbsp;&nbsp;&nbsp;{{
                        scope.row.obj_name
                      }}
                        &nbsp;&nbsp;&nbsp;&nbsp;{{
                          scope.row.obj_name
          ...
          >
            ...
            >
              ...
              <el-table-column
                ...
                :label="
                  matchData.integral_mode == 1
                    ? name.task.score.toString()
                    : name.dynamic_score.toString()
                "
                :class-name="index2 == 0 ? 'bor_l' : ''"
                min-width="40px"
              >
              ...
              >
                    ...
                    >
                      {{
                        the_rank_type == "layered"
                          ? scope.row.task.level_name
                          : scope.row.task.category_name
                      }}
                    </div>
                  </template>
                </el-table-column>
                ...
                >
                  <template slot-scope="scope">
                    <span>{{
                      scope.row.status == 1
                        ? $t("dialog_list.effective")
                        : $t("dialog_list.notEffective")
                    }}</span>
                  </template>
                </el-table-column>
                <el-table-column
...
import { ranks, rankTasks, tasks_detail } from '@/api/rw'
  ...
  methods: {
    ...
    tableClick(row) {
      ...
      this.$nextTick(() => {
        ...
        // console.log(this.match, "8888");
        this.match.event_mode == 1
