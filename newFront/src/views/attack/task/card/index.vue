      ...
      <el-row>
          ...
          <div class="grid-content bg-purple attack_match_info">
            <div class="title">
              ...
              >
                ...
                <span>{{ $t('attack.question_board.game_information') }}</span>
              </a>
            </div>
        ...
        <el-col :span="9">
          <div class="grid-content bg-purple attack_view_list attack_view_list_right">
            ...
            <ul v-if="attack_data.length" slot="content_begin" class="view_list">
              <li v-for="(item,index) in attack_data" :key="index+item.time">
            ...
            <div v-else slot="content_begin" class="view_list">
