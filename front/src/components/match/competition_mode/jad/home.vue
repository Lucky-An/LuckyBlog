  ...
  export default {
    ...
    data(){
      return{
        ...
        nav:[
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/jeopardy/guide',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.guide")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/jeopardy/notice',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.notice")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/jeopardy/contest_challenge',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.questionBoard")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/jeopardy/ranking',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.ranking")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/jeopardy/trend',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
