  ...
  export default {
    ...
    data(){
      return{
        ...
        nav:[
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/realWorld/guide',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.guide")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/realWorld/notice',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.notice")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/realWorld/contest_challenge',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.questionBoard")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/realWorld/ranking',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.ranking")
          },
          {
            path:'/'+window.location.pathname.split('/')[1]+'/match/realWorld/trend',
            query:{event:this.$route.query.event,hash:this.$route.query.hash},
            name:this.$t("header.match.trend")
          },
        ],
        api:{//接口数据
          matchStatus:rw_matchStatus,
          signup_users,
          signup_teams,
          notices,
          task_notices,
