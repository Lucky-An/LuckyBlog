...
export function fetchJeopardyFlag(params) {
  return request({
    url: '/api/v1/jeopardy/admin/task/flags/',
    method: 'get',
    params
  })
}
...
// 解题赛 题目类型管理  创建
export function fetchCreateType(data) {
  return request({
    url: '/api/v1/jeopardy/admin/categorys/',
    method: 'post',
    data
...
// 解题赛 题目类型管理  删除
export function fetchDeleteType(data) {
  return request({
    url: '/api/v1/jeopardy/admin/categorys/batch_destroy/',
    method: 'delete',
    data
  })
}
...
export function topicPublic(data) {
  return request({
    url: '/api/v1/jeopardy/admin/tasks/batch_public/',
    method: 'patch',
    data
  })
}
...
export function wpPublic(data) {
  return request({
    url: '/api/v1/jeopardy/admin/tasks/batch_writeup/',
    method: 'patch',
    data
  })
}
...
export function fetchWpList(params) {
  return request({
    url: '/api/v1/jeopardy/admin/writeups/',
    method: 'get',
    params
  })
}
...
export function removeWp(data) {
  return request({
    url: '/api/v1/jeopardy/admin/writeups/batch_destroy/',
    method: 'delete',
    data
  })
}
...
export function buyWp(params) {
  return request({
    url: '/api/v1/jeopardy/admin/writeups/purchasing/',
    method: 'get',
    params
  })
}
...
export function fetchCorrect(params) {
  return request({
    url: '/api/v1/jeopardy/admin/solvedlogs/',
    method: 'get',
    params
  })
}
...
export function fetchProposal(params) {
  return request({
    url: '/api/v1/jeopardy/admin/complains/',
    method: 'get',
    params
  })
}
...
export function fetchTag(params) {
  return request({
    url: '/api/v1/jeopardy/admin/tags/',
    method: 'get',
    params
  })
}
...
// 解题赛 题目标签管理  创建
export function fetchCreateTag(data) {
  return request({
    url: '/api/v1/jeopardy/admin/tags/',
    method: 'post',
    data
...
// 解题赛 题目标签管理  删除
export function fetchDeleteTag(data) {
  return request({
    url: '/api/v1/jeopardy/admin/tags/batch_destroy/',
    method: 'delete',
    data
  })
}
...
export function showTalking(params) {
  return request({
    url: '/api/v1/jeopardy/admin/task/discussion/',
    method: 'get',
    params
  })
}
...
export function postTest(data) {
  return request({
    url: '/api/v1/jeopardy/admin/task_test',
    method: 'post',
    data
  })
}
