    ...
    <div v-if="!is_share||!internet_id" class="internet_box">
      ...
      <el-form ref="ruleForm" :model="ruleForm" label-width="130px" class="internet_form">
        ...
        <el-form-item :label="internet_id?'VLAN':'VLAN范围'" prop="name_zh">
          <el-input :disabled="!is_user_share" v-model="ruleForm.vlan" style="width: 48%;" placeholder="例如：1050"/>
          <span v-if="!internet_id">
            --
            <el-input v-model.trim="ruleForm.vlan*1+teamNum*1-1" style="width: 48%;" disabled/>
          </span>
...
import { fetchTeamNum, addInternet, pollingAdd, editInternet, fetchInternet, fetchInternetInfo, matchJeopardyInfo } from '@/api/match/jeopardy'
