...
import { fetchTeamNum, addInternet, editInternet, fetchInternet } from '@/api/match/newAD'
...
export default {
  ...
  methods: {
    goback() {
      this.$router.push({ path: '/competition/newAD/editMatch/editMatch', query: { id: this.params.event_id, step: 3 }})
    },
    getTeamNum() {
