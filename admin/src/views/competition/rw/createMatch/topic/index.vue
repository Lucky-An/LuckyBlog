<template>
  <div class="app-container">
    ...
    <div class="btn_box topicStep_box">
      ...
      <router-link :to="{ path: '/competition/rw/index' }">
        <el-button style="margin-left: 10px" type="primary">完成</el-button>
      </router-link>

      <router-link
        :to="{ path: '/competition/rw/operation', query: { hash: hash } }"
      >
        <el-button style="margin-left: 10px" type="warning">竞赛运维</el-button>
      </router-link>
    </div>
