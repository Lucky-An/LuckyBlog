<template>
  <div class="app-container">
    <div class="filter-container">
      <el-select v-model="listQuery.name" placeholder="请选择操作员" class="filter-item" clearable size="mini" @change="log_message">
        <el-option
      ...
      <div style="float: right;">
        ...
        <el-button v-waves class="filter-item" size="mini" type="danger" @click="deleteLog">按时间删除日志</el-button>
      </div>
    </div>
    <el-table
      :data="matchList"
