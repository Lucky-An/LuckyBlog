<template>
  <el-breadcrumb class="app-breadcrumb" separator="/">
    <transition-group name="breadcrumb">
      ...
      <el-breadcrumb-item v-if="matchName" key="">
        <span class="no-redirect">{{ matchName.length>10?matchName.substr(0,10)+'...':matchName }}</span>
      </el-breadcrumb-item>
    </transition-group>
  </el-breadcrumb>
</template>
...
export default {
  ...
  computed: {
    matchName() {
      return this.$store.getters.matchName
    }
  },
  watch: {
    $route() {
